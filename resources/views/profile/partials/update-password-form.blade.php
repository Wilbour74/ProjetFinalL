<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
        ...
        <div>
            <x-input-label for="text-gray-400" :value="__('Mot de passe actuel')" />
            <x-text-input id="text-gray-400" name="current_password" type="password" class="mt-1 block w-full" autocomplete="current-password" />
